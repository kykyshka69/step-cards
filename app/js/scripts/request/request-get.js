...
function getCard() {
  fetch("https://ajax.test-danit.com/api/v2/cards", {
    ...
    .then((data) => {
      ...
      if (data.length === 0){
        main.insertAdjacentHTML("afterbegin", `<figure class="text-center position-absolute top-50 start-50 translate-middle"><h1 class="display-1">No items have been added</h1></figure>`)
      } else {
        data.forEach((item, i) => {
          const {
            id = "",
